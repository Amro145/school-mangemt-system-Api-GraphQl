...
--> statement-breakpoint
INSERT INTO
    `__new_classRoom` ("id", "name", "schoolId")
...
--> statement-breakpoint
INSERT INTO
    `__new_school` ("id", "name", "adminId")
SELECT "id", "name", "adminId"
FROM `school`;
--> statement-breakpoint
DROP TABLE `school`;
--> statement-breakpoint
ALTER TABLE `__new_school` RENAME TO `school`;
--> statement-breakpoint
...
SELECT "id", "studentId", "subjectId", "classId", "score"
FROM `studentGrades`;
--> statement-breakpoint
...
DROP TABLE `subject`;
--> statement-breakpoint
ALTER TABLE `__new_subject` RENAME TO `subject`;
--> statement-breakpoint
