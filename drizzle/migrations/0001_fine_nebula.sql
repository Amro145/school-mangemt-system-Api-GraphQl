...
INSERT INTO `__new_studentGrades`("id", "studentId", "subjectId", "classId", "score", "dateRecorded") SELECT "id", "studentId", "subjectId", "classId", "score", "dateRecorded" FROM `studentGrades`;--> statement-breakpoint
